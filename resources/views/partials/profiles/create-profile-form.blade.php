            ...
            @if(!isset(Auth::user()->profile->id))
                <button title="{{ __('infotable.button_create') }}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
            ...
            @else
                <a href="edit-profile/update/{{ Auth::user()->profile->id }}" title="{{ __('infotable.button_edit') }}" class="ml-5 bg-blue-400 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
