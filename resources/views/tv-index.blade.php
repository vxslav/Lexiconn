    ...
    <x-slot name="header">
        <div class="container mx-auto flex items-center flex-col md:flex-row justify-between">
            ...
            <ul class="flex items-center flex-col md:flex-row">
                <li class="md:ml-6 mt-3 md:mt-0 text-gray-400 hover:text-gray-600 text-sm"><a href="#top-rated">#Top Rated TV Shows</a></li>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="top-rated-tv" id="top-rated">
                        <h3 class="uppercase tracking-wider text-purple-500 text-lg font-semibold">Top Rated TV Shows</h3>
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-16">
                            ...
                            @foreach($topRatedTV as $show)
                                ...
                                <div class="mt-8">
                                    ...
                                    <div class="mt-2">
                                        <a href="{{ route('tv.show', $show['id']) }}" class="text-lg mt-2 hover:text-purple-500">{{ $show['name'] }}</a>
                                        <div class="flex items-center text-gray-800 text-sm mt-1">
                                            ...
                                            <span>@if(isset($show['first_air_date']))
