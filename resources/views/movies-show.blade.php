<x-app-layout>
 ...
 <!-- Movie Details Section -->
    <div class="py-12 container movie-info">
        <div class="max-w-7xl sm:px-6 lg:px-8">
            <div class="bg-white mx-auto overflow-hidden shadow-sm sm:rounded-lg px-4 py-16 flex flex-col md:flex-row">
                @if($movie['poster_path'])
                <img class="p-6 bg-white w-64 lg:w-96" src={{ "https://image.tmdb.org/t/p/w500/".$movie['poster_path'] }}  alt="Poster">
                @else
                ...
                <div class="ml-24 mt-10">
                    ...
                    <div class="mt-10">
                        <h4 class="font-semibold text-gray-800 border-b border-gray-200">Featured Crew</h4>
                        <div class="flex mt-4">
                    ...
                    @if(count($movie['videos']['results']) > 0)
                        <div class="mt-10">
                            <a href="https://youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" class="flex inline-flex items-center bg-yellow-400 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-yellow-300 transition ease-in-out duration-200 ">
    ...
    <!-- Movie Cast Section -->
    <div id="cast" class="py-12 container movie-info">
        <div class="max-w-7xl sm:px-6 lg:px-8">
            <div class="bg-white mx-auto overflow-hidden shadow-sm sm:rounded-lg px-4 py-16 flex flex-col md:flex-row">
